  ...
  public: {
    Tables: {
      ...
      gptIdeasLikes: {
        ...
        Relationships: [
          {
            foreignKeyName: "gptIdeasLikes_gpt_idea_id_gpt_ideas_gpt_idea_id_fk"
            columns: ["gpt_idea_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "gptIdeasLikes_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
      ...
      messageRoomMembers: {
        ...
        Relationships: [
          {
            foreignKeyName: "messageRoomMembers_message_room_id_messageRoom_message_room_id_"
            columns: ["message_room_id"]
            isOneToOne: false
            referencedRelation: "messageRoom"
            referencedColumns: ["message_room_id"]
          },
          {
            foreignKeyName: "messageRoomMembers_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
      ...
      messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "messages_message_room_id_messageRoom_message_room_id_fk"
            columns: ["message_room_id"]
            isOneToOne: false
            referencedRelation: "messageRoom"
            referencedColumns: ["message_room_id"]
      ...
      postReplies: {
        ...
        Relationships: [
          {
            foreignKeyName: "postReplies_parent_id_postReplies_post_reply_id_fk"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "postReplies"
            referencedColumns: ["post_reply_id"]
          },
          {
            foreignKeyName: "postReplies_post_id_posts_post_id_fk"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "community_post_list_view"
            referencedColumns: ["post_id"]
          ...
          {
            foreignKeyName: "postReplies_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
      ...
      postUpvotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "postUpvotes_post_id_posts_post_id_fk"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "community_post_list_view"
            referencedColumns: ["post_id"]
          ...
          {
            foreignKeyName: "postUpvotes_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
    ...
    Enums: {
      job_type:
        ...
        | "freelance"
        | "internship"
      location: "anywhere" | "local" | "hybrid"
...
export const Constants = {
  public: {
    Enums: {
      job_type: ["full-time", "part-time", "remote", "freelance", "internship"],
      location: ["anywhere", "local", "hybrid"],
      notification_type: ["follow", "review", "reply", "mention"],
      product_stage: ["idea", "prototype", "mvp", "launched"],
